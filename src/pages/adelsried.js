        ...
        <div>
          <div>
            ...
            <p className="imprint-disclaimer">
              ...
              Anfänger, Fortgeschrittner oder Profi, über neue Gesichter freuen
              wir uns immer.
            </p>
          </div>
          ...
          <div>
            <ul className="bullet-list">
              <li>
                ...
                eine tolle Wirtschaft mit fairen Preisen und allem was das Herz
                begehrt.
              </li>
              <li>
                <span >
      ...
      <div>
        <div>
          ...
          <p className="imprint-disclaimer">
            ...
            Drone Racing gefunden. Auf den monatlichen Races sind natürlich alle
            Piloten eingeladen auch Nichtmitglieder. Hier geht es ja schließlich
            darum das sich ALLE Piloten von Überall gegeneinander messen können
            und im fairen Wettstreit gegeneinander antreten und miteinander
            trainieren. Nur müssen wir natürlich für Nichtmitglieder eine kleine
            Gebühr verlangen wenn sie an den monatlichen Rennen teilnehmen
            wollen oder mal mit trainieren. Es lohnt sich also Mitglied zu
            werden.
          </p>
          ...
          <p className="imprint-disclaimer">
            ...
            offizielle Heimat für Drohnenpiloten in einem eingetragenen Verein.
            Um mitzumachen müsst ihr kein BMR Mitglied sein! SV Adelsried
            Droneracing handelt eigenständig und ist eine offizielle Abteilung
            des Vereins SV Adelsried. BMR stellt der neuen Abteilung die volle
            Unterstützung und alles Material zur Seite! Und die meisten BMR
            Vertreter sind natürlich Mitglied.
          </p>
        </div>
      </div>
    </div>
