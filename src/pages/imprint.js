  ...
  <Layout pageTitle="Impressum" sidebarContent={SIDEBAR_CONTENTS.IMPRINT}>
    ...
    <Card>
      <CardBody>
        ...
        <p>
          <span>
            Telefon: +49 (0) 170 18 88 82 5
            <br />
            E-Mail: r.stach.muc@gmail.com
          </span>
        </p>
        <p>Datenschutzbeauftragte/r beim Anbieter ist:</p>
        <p>
          <span>Robert Stach&nbsp;</span>
        </p>
        ...
        <p>
          ...
          Daten (also bspw. Ihren Namen, Ihre Anschrift oder Ihre
          E-Mail-Adresse) ausschließlich für vorvertragliche Leistungen, für die
          Vertragserfüllung oder zum Zwecke der Kundenpflege (bspw. um Ihnen
          eine Übersicht über Ihre bisherigen Bestellungen bei uns zur Verfügung
          zu stellen oder um Ihnen die sog. Merkzettelfunktion anbieten zu
          können) erheben und speichern. Gleichzeitig speichern wir dann die
          IP-Adresse und das Datum Ihrer Registrierung nebst Uhrzeit. Eine
        ...
        <p>
          ...
          Verarbeitung eingeholt und auf diese Datenschutzerklärung verwiesen.
          Die dabei von uns erhobenen Daten werden ausschließlich für die
        ...
        <p>
          ...
          Kundenkontos können Sie gemäß Art. 7 Abs. 3 DSGVO jederzeit mit
        ...
        <p>
          ...
          verarbeiten und veröffentlichen wir Ihren Beitrag, Datum und Uhrzeit
          der Einreichung sowie das von Ihnen ggf. genutzte Pseudonym.
        </p>
        <p>
        ...
        <p>
          ...
          YouTube. Die Google LLC ist unter dem Privacy Shield zertifiziert und
          hat sich damit verpflichtet, die europäischen Datenschutzstandards
          einzuhalten
        </p>
        <p>
          <a
