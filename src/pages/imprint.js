  ...
  return (
    <Layout pageTitle='Impressum'>
      ...
      <div className='imprint'>
        <div className='imprint-contact-info'>
          <div>
          ...
          <div>
            <h3>Kontakt:</h3>
            <p className='imprint-contact-info-contents'>
              <br/>Telefon: +49 (0) 170 18 88 82 5
              <br/>E-Mail: <a href='mailto:r.stach.muc@gmail.com'
                              className='mail-to'>r.stach.muc@gmail.com</a>
            </p>
          </div>
          <div>
            ...
            <p className='imprint-contact-info-contents'>
              ...
              <br/>Krautheimstr. 27a
              <br/>80997 München
              <br/>Quelle: <a href='https://www.e-recht24.de' className='mail-to'>www.e-recht24.de</a>
            </p>
          </div>
          <div>
            <h3>Webdesign</h3>
            <p className='imprint-contact-info-contents'>
              <br/>Chi-Tin Ho
              <br/>E-Mail: <a href='mailto:ho.chi-tin@gmx.de' className='mail-to'>Ho.Chi-Tin@gmx.de</a>
              {/*<br/>Homepage: <a href='https://www.google.de' className='mail-to'>www.mr-Ho404.de</a>*/}
            </p>
            <p className='imprint-contact-info-contents'> Bilder von: <a
              href="https://www.facebook.com/revomotionmedia/" className='mail-to'>Niklas Solle</a></p>
            <p className='imprint-contact-info-contents'>Icons von: <a
              href="https://www.flaticon.com/authors/freepik" className='mail-to'>www.flaticon.com</a></p>
          </div>
        </div>
        <div className='imprint-disclaimer'>
          ...
          <div>
            ...
            <p>
              ...
              Datenschutzvorschriften sowie dieser Datenschutzerklärung. Die Nutzung unserer Webseite ist in
              ...
              ausdrückliche Zustimmung nicht an Dritte weitergegeben. Wir weisen darauf hin, dass die
